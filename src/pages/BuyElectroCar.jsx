  ...
  async function getTokenFromServer() {
    try {
      const response = await axios.post(
        "https://evion-cars-api-a533851fe462.herokuapp.com/get-access-token"
      );
  ...
  function order() {
    ...
    validationSchema
      ...
      .then(() => {
        ...
        axios
          .post(
            "https://evion-cars-api-a533851fe462.herokuapp.com/create-leads",
            leadData,
            config
          )
          .then((response) => {
